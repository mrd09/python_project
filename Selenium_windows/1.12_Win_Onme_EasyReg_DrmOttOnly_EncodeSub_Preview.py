...
# Input Title
title_text="_Onme_EasyReg_DrmOttOnly_EncodeSub_Preview"
...
try:
    ...
    # Navigate "Onme Tab":
    onme=driver.find_element_by_link_text('OnMe Only')
    onme.click()
    time.sleep(1)
...
#    if AlreadyEncode.is_enabled():
#        if AlreadyEncode.is_selected():
#            print('Checkbox AlreadyEncode already selected');
#        else:
#            AlreadyEncode.click()
#            print('Checkbox AlreadyEncode selected')
#    else:
#        print('Checkbox AlreadyEncode is disabled')

    # ** Onme only register encode HQ only default always select HQ
...
#    #Select DRM option: OnMe default OTT DRM only
#    drm_hyb=driver.find_element_by_xpath("//div[2]/div[24]/div/div[1]/label/span")
#    drm_hyb.click()
#
#    drm_ott=driver.find_element_by_xpath("//form/div[2]/div[24]/div/div[2]/label/span")
#    drm_ott.click()
