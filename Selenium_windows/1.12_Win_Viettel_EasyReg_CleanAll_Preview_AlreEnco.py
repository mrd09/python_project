...
# Input Title
title_text="_Viettel_EasyReg_CLeanAll_Preview_AlreEnco"
...
#   time.sleep(2)
    ...
    if AlreadyEncode.is_enabled():
        ...
        print('Checkbox AlreadyEncode are disabled')
    ...
    if encode_SD.is_enabled():
        ...
        print('Checkbox encode_SD are disabled')
    ...
    if encode_HD.is_enabled():
        ...
        print('Checkbox encode_HD are disabled')
